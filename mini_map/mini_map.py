import cv2
import numpy as np
from constants.config_constants import (PLAYER_1_HEIGHT, PLAYER_2_HEIGHT, 
                                        DOUBLE_LINE_WIDTH, SINGLE_LINE_WIDTH, 
                                        HALF_COURT_LINE_HEIGHT, NO_MANS_LAND_HEIGHT, 
...
from utils.bbox_utils import (get_foot_positions, 
...
class MiniCourt():
    ...
    # mini-map background for all frames
    ...
    def get_mini_court_coordinates(self, object_position, 
        ...
        distance_from_key_point_x_meters = convert_pixel_distance_to_meters(distance_from_key_point_x_pixels, 
                                                                            player_height_in_meters, 
                                                                            player_height_in_pixels)
        
        distance_from_key_point_y_meters = convert_pixel_distance_to_meters(distance_from_key_point_y_pixels, 
                                                                            player_height_in_meters, 
                                                                            player_height_in_pixels)
        
        # convert to mini map coordinates
        mini_court_x_distance_pixels = self.convert_meters_to_pixels(distance_from_key_point_x_meters)
        mini_court_y_distance_pixels = self.convert_meters_to_pixels(distance_from_key_point_y_meters)
    ...
    def convert_bounding_boxes_to_mini_map_coordinates(self, player_boxes, ball_boxes, original_court_key_points):
        player_heights = {1: PLAYER_1_HEIGHT,
                          2: PLAYER_2_HEIGHT}
