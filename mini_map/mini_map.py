import cv2
import numpy as np
from constants.config_constants import DOUBLE_LINE_WIDTH, SINGLE_LINE_WIDTH, HALF_COURT_LINE_HEIGHT, NO_MANS_LAND_HEIGHT, NO_MANS_LAND_HEIGHT, SINGLE_LINE_WIDTH, DOUBLE_ALLY_DIFFERENCE
...
class MiniCourt():
    def __init__(self, frame):
        ...
        self.buffer = 50
        self.padding = 20
        self.draw_canvas_background_box_position(frame)
    ...
    def draw_canvas_background_box_position(self, frame):
        frame = frame.copy()
